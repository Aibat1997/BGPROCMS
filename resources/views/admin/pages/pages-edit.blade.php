                                ...
                                <div class="tab-content" id="nav-tabContent">
                                    <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea id="froala" name="page_content_ru">{{ !empty($page) ? $page->page_content_ru : old('page_content_ru') }}</textarea>
                                        </div>
                                    </div>
                                    <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
                                        ...
                                        <div class="form-group">
                                            <label>Описание</label>
                                            <textarea id="froala" name="page_content_kz">{{ !empty($page) ? $page->page_content_kz : old('page_content_kz') }}</textarea>
                                        </div>
                                    </div>
                                    <div class="tab-pane fade" id="nav-contact" role="tabpanel" aria-labelledby="nav-contact-tab">
                                        ...
                                        <div class="form-group">
                                            <label>Описание</label>
                                            <textarea id="froala" name="page_content_en">{{ !empty($page) ? $page->page_content_en : old('page_content_en') }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
